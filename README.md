...
**Click "Run One Step"** to execute one statement across all threads
**Inspect state** in the tables:
...
**Select different threads** in the Program States list to view their individual state
